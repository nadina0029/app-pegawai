...
@section('content')
    <form action="{{ route('positions.store') }}" method="POST" class="max-w-xl mx-auto bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="number" id="gaji_pokok" name="gaji_pokok" class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:ring-indigo-500 focus:border-indigo-500">
        </div>
